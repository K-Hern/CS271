...
void reverse(char* txt, char* result) {
    ...
    /* REPLACE WITH YOUR CODE */
    int index = (strlen(txt)-1);
    int counter = 0;
    while (index >=0)
    {
        result[counter] = txt[index];
        counter ++;
        index --;
    }
    result[counter] = '\0';
...
int vowels(char* txt) {
    ...
    while (index != -1)
    {
        if (txt[index] == 'a' || txt[index] == 'A')
        {
            vowel ++;
        }else if(txt[index] == 'e' || txt[index] == 'E')
        {
            vowel ++;
        }else if(txt[index] == 'i' || txt[index] == 'I')
        {
            vowel ++;
        }else if(txt[index] == 'o' || txt[index] == 'O')
        {
            vowel ++;
        }else if(txt[index] == 'u' || txt[index] == 'U')
        {
            vowel ++;
        }
...
int main(int argc, char** argv)
{
	...
	if (argc < 2){
		...
		printf("%s is in quartile #%d alphabetically.\n\n\n", name, quartile(name));		
	}else{
		/******************************
